...
class InvalidArgumentAmazonException(Error):
    ...
    code_message = "invalid_arguments"
    pass


class CategoryNotExistException(Error):
    """Category not exists"""
    code_message = "category_not_exist"
    pass


class UrlNotDefinedAmazonException(Error):
    """Url not defined """
    code_message = "url_not_defined"
    pass
